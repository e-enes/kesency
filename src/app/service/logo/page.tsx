  ...
  const process = [
    {
      ...
      image: CDN + "/images/services/process-tab/logo-and-branding-process/logo-and-branding-process-img-1.svg",
    ...
    },
    {
      ...
      image: CDN + "/images/services/process-tab/logo-and-branding-process/logo-and-branding-process-img-2.svg",
    ...
    },
    {
      ...
      image: CDN + "/images/services/process-tab/logo-and-branding-process/logo-and-branding-process-img-3.svg",
    ...
    },
    {
      ...
      image: CDN + "/images/services/process-tab/logo-and-branding-process/logo-and-branding-process-img-4.svg",
    ...
    },
    {
      ...
      image: CDN + "/images/services/process-tab/logo-and-branding-process/logo-and-branding-process-img-5.svg",
  ...
  return (
    <React.Fragment key={"logo"}>
      ...
      <DescriptionService image={CDN + "/images/services/logo-and-branding.svg"}>
        ...
        <p>
          Branding is an essential element of any business or organization, and it plays a critical role in attracting and retaining
          customers. A brand is more than just a logo; it encompasses the entire image and perception of a business, including its products,
          services, values, and customer experience. Branding matters because it helps to differentiate a business from its competitors and
